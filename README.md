...
- Resolved 2026-09-17: `requirements.txt`'s pyarrow pin was bumped to `>=20.0,<26` (see decision log), which installs cleanly on Python 3.14. No remaining open issues.
